...
public struct CredentialSubjectDTO: Codable, Equatable, Hashable, Sendable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        flowAccount = try container.decodeIfPresent(String.self, forKey: .flowAccount)
        did = try container.decodeIfPresent(String.self, forKey: .did)
        assuranceLevel = try container.decodeIfPresent(String.self, forKey: .assuranceLevel)
    }
