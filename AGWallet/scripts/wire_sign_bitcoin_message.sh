...
PATCH_SCRIPT="${AGWALLET_DIR}/scripts/patch_sign_bitcoin_message.py"

echo "==> Wiring signBitcoinMessage(_:chain:) via ${PATCH_SCRIPT}"
cd "${AGWALLET_DIR}"
...
echo "==> wire_sign_bitcoin_message.sh completed successfully"
